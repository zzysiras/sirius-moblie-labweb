...
class Home extends Language {
  ...
  componentWillMount(){
    axios.get("http://localhost:8081/demo/banner").then(
      res => {
  ...
  render() {
    ...
    return (
      <div className="home-page">
        <section className="top-section" style={{backgroundImage:`url(${this.state.background})`}}>
          <Header
            currentKey="home"
            type={headerType}
            logo={headerLogo}
        ...
        <section className="start-section">
          <div className="start-body">
            ...
            <div className="right-part"><img src={dataSource.start.img} /></div>
          </div>
        </section>
